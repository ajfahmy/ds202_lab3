...
```{r}
ggplot(never, aes(x = `General happiness`)) + geom_histogram(stat="count") + theme(axis.text.x = element_text(angle = 90)) + facet_wrap(~ `Number of children`, scales = "free")
...
#ggplot(dat2, aes(x=`Number of children`, y=`General happiness`))
...
```{r}
ggplot(dat, aes(x = `Number of hours usually work a week`)) + geom_bar() + theme(axis.text.x = element_text(angle = 90))
```
...
```{r}
ggplot(dat, aes(x = `General happiness`)) + geom_histogram(stat="count") + theme(axis.text.x = element_text(angle = 90)) + facet_wrap(~ `Belief in life after death`, scales = "free")
```
